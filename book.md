# ${cont_model} 로봇제어기 기능설명서 - 센서 기반 힘제어 
...
해당 기능은 V60.32-01 버전 부터 사용 가능하고, 기능 라이센스가 별도로 필요 합니다. # 🧩 2. 설정
...
<br>
 ...
 💡 *Function Use*, *Sensor Type*, *Comm. protocol*, IP 주소 등을 반드시 정확히 입력해야 센서가 정상 작동합니다.## 🧩 2.3 힘 제어 툴 정보
...
> 💡 Hi5a에 제공된 센서기반부하추정 기능은 미지원 ## 🧩 2.4 힘 제어 조건 설정
...
📌 `접촉면 판단 기준` 기능을 올바르게 사용하기 위해서는, 선택된 좌표계가 **툴 좌표계** 기준으로 설정되어야 한다.   ## 🧩 2.4.4.2 힘 제어 조건 설정-모션-자동 경로 생성  
